using System;
using loggingTdddemo;

namespace ClassesDemo
{
    public class Human : Animal, Ipilot
    {
        ...
        public LoggerClass _logger { get; set; }
        #endregion
        ...
        }// creating this parameterless constructor because serialization requires a parameterless constructor
        ...
        public void LogThatHuman()
        {
            this._logger.CreatedHuman(this);
        }

        public void AnimalAge(int age)
        {
            this.MyAnimalAge.AnimalAge = age;
            this._logger.HumanAgeSet(this, age);
        }

        public bool TryAnimalAge(int age)
        {
            if (age > 0 && age < 120)
            {
                this.MyAnimalAge.AnimalAge = age;
        ...
        public bool ChangeThisBool(bool b)
        {
            b = !b;
            return b;
        }

        public int ChangeThisInt(int b)
        {
            b = ++b;
            return b;
        }
        ...
        public Human ChangeThisName(Human h /*0x56fba*/)
        {
            h/*0x56fba*/.Fname = "Bradley";
            h/*0x56fba*/.Lname = "Cooper";
            return h/*0x56fba*/;
        }
